...
def _build_prompt(
    ...
    return (
        ...
        "not contain source identifiers, row codes, bullets, numbering, markdown, labels, "
        "headings, placeholders, or unnecessary symbols. Do not copy source identifiers "
        "such as BR-SEN-001, AC-001, FR-001, or NFR-001 into req_text.\n"
